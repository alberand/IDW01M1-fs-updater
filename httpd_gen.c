/*  Copyright 2012 Sagrad, Inc.  All Rights Reserved.
 *
 *  Permission is granted to use this tool to generate HTTPD filesystem
 *  images for the SG901-1203 Intelligent Wifi Module Family.  All other
 *  uses are prohibited.
 *
...
#ifdef APPEND_HEADER
		hff->flags = 0x2;	/* only FSDATA_EXTERNAL flag */
#else
		hff->flags = 0x1 | 0x2;	/* FSDATA_HEADER_INFO_INCLUDED + FSDATA_EXTERNAL flag */
#endif
		hs.num++;
	}
